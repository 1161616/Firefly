...
description: 用于验证 HanYion 中 PlantUML 插件渲染、主题切换与交互能力的示例文章。
tags: [PlantUML, HanYion, Markdown]
category: 文章示例
draft: false
---
...
在 HanYion 中，`plantuml` 代码块会在构建阶段编码并生成服务器 SVG 地址，页面端再根据亮暗主题自动切换图源，并支持缩放、拖拽和全屏交互。
...
System_Boundary(system, "HanYion Blog") {
