...
>[!TIP]
>
>HanYion は、Astro フレームワークと Fuwari テンプレートをベースに開発された、清新で美しくモダンな個人ブログテーマテンプレートです。技術愛好家やコンテンツクリエイター向けに設計されており、モダンな Web 技術スタックを統合し、豊富な機能モジュールと高いカスタマイズ性を備えたインターフェースで、プロフェッショナルで美しい個人ブログを手軽に構築できます。
>
>主要なレイアウト面では、HanYion は左右のデュアルサイドバー、記事グリッド（多カラム）レイアウト、メイソンリーレイアウトを革新的に追加しています。
>
...
>
>**HanYion の上記コンポーネント設計や関連コードを参考または利用する場合は、出典として HanYion を明記してください。**
>
>HanYion はオリジナルの fuwari レイアウトも保持しており、設定ファイルで好みに応じて自由に切り替えられます。
>
>**レイアウト設定とデモの詳細については、[HanYion レイアウトシステム詳解](https://firefly.cuteleaf.cn/posts/firefly-layout-system/)をご覧ください**
>
>HanYion は i18n の多言語 UI をサポートしていますが、簡体字中国語以外の言語は AI 翻訳です。誤りがある場合は、[Pull Request](https://github.com/CuteLeaf/HanYion/pulls) の提出を歓迎します。
...
便利な機能や最適化があれば、[Pull Request](https://github.com/CuteLeaf/HanYion/pulls)を提出してください
...
1. **リポジトリのクローン：**
   ...
   **まず自分のリポジトリに[Fork](https://github.com/CuteLeaf/HanYion/fork)してからクローン（推奨）。クローンする前にStarをクリックするのを忘れずに！**
...
> 📚 **詳細な設定ドキュメント**：[HanYionドキュメント](https://docs-firefly.cuteleaf.cn/)で完全な設定ガイドを確認してください
...
[fuwari](https://github.com/saicaca/fuwari)テンプレートを開発した[saicaca](https://github.com/saicaca)に深く感謝します。HanYionはこのテンプレートをベースに二次開発されています。
...
このプロジェクトに貢献してくれた以下の貢献者に感謝します。質問や提案がある場合は、[Issue](https://github.com/CuteLeaf/HanYion/issues)または[Pull Request](https://github.com/CuteLeaf/HanYion/pulls)を提出してください。
