...
>[!TIP]
>
>HanYion 是一款基於 Astro 框架和 Fuwari 模板開發的清新美觀且現代化個人部落格主題模板，專為技術愛好者和內容創作者設計。該主題融合了現代 Web 技術棧，提供了豐富的功能模組和高度可自訂的介面，讓您能夠輕鬆打造出專業且美觀的個人部落格網站。
>
>在重要的版面上，HanYion 創新性地增加了左右雙側邊欄、文章網格（多列）版面、瀑布流版面。
>
>增加了站點統計、日曆、文章目錄、音樂播放器、快捷分類導覽等小元件，讓側邊欄和整體頁面版面更加豐富。
>
>同時也增加了分享海報、相關文章推薦、隨機文章等元件，讓文章頁面內容更加豐富。
>
>**如果你參考或使用了 HanYion 以上元件設計和相關程式碼，請註明來自 HanYion。**
>
>HanYion 也保留了原版 fuwari 的版面，可根據自己的喜好在配置檔案中自由切換。
>
>**更多版面配置及示範請查看：[HanYion 版面配置系統詳解](https://firefly.cuteleaf.cn/posts/firefly-layout-system/)**
>
>HanYion 支援 i18n 多語言 UI，但除了簡體中文，其他語言均為 AI 翻譯轉換，如有錯誤，歡迎提交 [Pull Request](https://github.com/CuteLeaf/HanYion/pulls) 修正。
...
如果你有好用的功能和優化，請提交 [Pull Request](https://github.com/CuteLeaf/HanYion/pulls)
...
1. **克隆儲存庫：**
   ...
   **先 [Fork](https://github.com/CuteLeaf/HanYion/fork) 到自己儲存庫再克隆（推薦），記得先點 Star 再 Fork 哦！**
...
> 📚 **詳細配置文檔**: 查看 [HanYion使用文檔](https://docs-firefly.cuteleaf.cn/) 獲取完整的配置指南
...
非常感謝 [saicaca](https://github.com/saicaca) 開發的 [fuwari](https://github.com/saicaca/fuwari) 範本，HanYion 就是基於這個範本二次開發
...
感謝以下貢獻者對本專案做出的貢獻，如有問題或建議，請提交 [Issue](https://github.com/CuteLeaf/HanYion/issues) 或 [Pull Request](https://github.com/CuteLeaf/HanYion/pulls)。
